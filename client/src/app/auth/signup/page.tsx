    ...
    <div className="h-screen w-screen bg-zinc-950 flex justify-center items-center">
      <div className="p-4 bg-zinc-900 border-zinc-800 border rounded-md text-zinc-100 w-96">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <PasswordInput id="password" disabled={loading} placeholder="Enter Password" {...register("password")} />
          <Label label="Confirm Password" htmlFor="confirmPassword" />
          <PasswordInput id="confirmPassword" disabled={loading} placeholder="Confirm Password" {...register("confirmPassword")} />
          <button
            disabled={loading}
